...
class Voltage_sensor:
    ...
    '''
    def __init__(self, volt, sensor_detection_threshhold = 1.6, error_threshhold = 2.5, min_readings = 10 ) -> None:
...
def get_tools(self, file):
    ''' this is not a good way to get tools'''
    tools_list = []
    tools = {}
        # LOAD ALL THE TOOLS
