...
class Gate_button():
    ...
    width = gate_width
    height = gate_height
    #font = pygame.font.Font('./Menlo.ttc', 6, bold=False)
    font = pygame.font.SysFont('Menlo', 6, bold=True)
...
class Tool_button():
    ...
    status = False
    font = pygame.font.Font('./fonts/Menlo Bold.ttf', 12, bold=True, italic = True)
    #font = pygame.font.SysFont('Menlo', 10, bold=True)
